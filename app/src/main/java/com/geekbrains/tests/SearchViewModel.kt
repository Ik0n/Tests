...
import com.geekbrains.tests.MainActivity.Companion.BASE_URL
...
internal class SearchViewModel(
    private val repositoryContract: RepositoryContract = GitHubRepository(
        Retrofit.Builder()
            .baseUrl(BASE_URL)
    ...
    fun searchGitHub(searchQuery: String) {
        ...
        viewModelCoroutineScope.launch {
            ...
            if (searchResults != null && totalCount != null) {
                ...
                _liveData.value = ScreenState.Error(Throwable("Search results or total count are null"))
            }
        }
    }

    private fun handleError(error: Throwable) {
        _liveData.value = ScreenState.Error(Throwable(error.message ?: "Response is null or unsuccessful"))
    }
